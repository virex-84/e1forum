(function () {
	...
	var defaultOptions = {
		...
		toolbar: 'bold,italic,underline,strike,subscript,superscript|' +
			...
			*/
        //toolbar: 'bold,italic,underline,strike|code,image,link,emoticon,youtube,source',
        //нам нужны только смайлы
        toolbar: 'emoticon',
		 ...
		 * @type {string}
		 */
		locale: attr(document.documentElement, 'lang') || 'ru',
		...
		emoticons: {
            ...
            ':-)':	'icons/smile3.gif',
            ';-)':	'icons/wink.gif',
            ':-D':	'icons/hollywood.gif',
            ':lol:':	'icons/lol.gif',
            ':-(':	'icons/sad.gif',
            ':weep:':	'icons/cray.gif',
            ':-p':	'icons/blum2.gif',
            ':hi:':	'icons/preved.gif',
            ':cool:':	'icons/dirol.gif',
            ':super:':	'icons/dance4.gif',
            ':ultra:':	'icons/rtfm.gif',
            ':beach:':	'icons/beach.gif',
            '8(':	'icons/shok.gif',
            ':fotku:':	'icons/fotku.gif',
            ':-o':	'icons/blush2.gif',
            ':mad:':	'icons/crazy.gif',
            ':confused:':	'icons/confused.gif',
            ':facepalm:':	'icons/facepalm.gif',
            ':vote:':	'icons/wild.gif',
            ':away:':	'icons/suicide2.gif',
            ':help:':	'icons/help.gif',
            },
            more: {
            ':kiss:':	'icons/air_kiss.gif',
            ':gun:':	'icons/gigakach_01.gif',
            ':bs:':	'icons/mda.gif',
            ':flowers:':	'icons/i_daisy.gif',
            ':beer:':	'icons/drinks.gif',
            ':food:':	'icons/d_sweet.gif',
            ':bayan:':	'icons/laie_48.gif',
            ':cen:':	'icons/smile_27.gif',
            ':popcorn:':	'icons/popcorm2.gif',
            ':nunu:':	'icons/threaten.gif',
            ':hihiks:':	'icons/sarcastic_hand.gif',
            ':box:':	'icons/kez_02.gif',
            ':vis:':	'icons/hang1.gif',
            ':nud:':	'icons/mega_shok.gif',
            ':figa:':	'icons/snooks.gif',

            ':ban:':	'icons/close_tema.gif',
            ':appl:':	'icons/clapping.gif',
            ':ultra:':	'icons/rtfm.gif',
            ':bes:':	'icons/diablo.gif',
            ':manyak:':	'icons/vampire.gif',
            ':suxx:':	'icons/dash1.gif',
            ':puke:':	'icons/bad.gif',
            ':write:':	'icons/write.gif',
            ':exclam:':	'icons/exclam.gif',
            ':disco:':	'icons/disco.gif',
            ':heat:':	'icons/heat.gif',
            ':niceread:':	'icons/niceread.gif',
            ':coolsaint:':	'icons/coolsaint.gif',
            ':redcard:':	'icons/redcard.gif',
            ':cold:':	'icons/cold.gif',

            ':fear:':	'icons/fear.gif',
            ':fizra:':	'icons/fizra.gif',
            ':music:':	'icons/music.gif',
            ':ded+1:':	'icons/ded.gif',
            ':hohoho:':	'icons/hohoho.gif',
            ':petard:':	'icons/petard.gif',
            ':snowball:':	'icons/snowball.gif',
            ':biggun:':	'icons/biggun.gif',
            ':commando:':	'icons/commando.gif',
            ':crazypilot:':	'icons/crazypilot.gif',
            ':girlkiss:':	'icons/girlkiss.gif',
            ':military:':	'icons/military.gif',
            ':pogranichnik:':	'icons/pogranichnik.gif',

            ':boykissgirl:':	'icons/boykissgirl.gif',
            ':girldance:':	'icons/girldance.gif',
            ':pinkglasses:':	'icons/pinkglasses.gif',
            ':spruceup:':	'icons/spruceup.gif',
            ':teddy:':	'icons/teddy.gif',
            ':whirlindance:':	'icons/whirlindance.gif',
            ':stadium:':	'icons/stadium.gif',
            ':cheerleading:':	'icons/cheerleading.gif',
            ':fire:':	'icons/fire.gif',

            ':laie:':	'icons/laie.gif',
            ':padre:':	'icons/padre.gif',
            ':boom:':	'icons/boom.gif',
            ':girl_sigh:':	'icons/girl_sigh.gif',
            ':girl_witch:':	'icons/girl_witch.gif',
            ':king:':	'icons/king.gif',
            },
	...
	function SCEditor(original, userOptions) {
		...
		updateActiveButtons = function () {
            ...
            var objects = ['bold','italic','underline','strikethrough','code','image','url','emoticon','youtube','source'];
			for (var j = 0; j < objects.length; j++) {

			  if (typeof(android) !== "undefined"){///!!!

			  var state = doc.queryCommandState(objects[j]) ? 1 : 0;
